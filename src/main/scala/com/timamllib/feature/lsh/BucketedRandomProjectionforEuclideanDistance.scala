 ...
 */
object BucketedRandomProjectionforEuclideanDistance {
  def main(args: Array[String]): Unit = {
    val sparkConf = new SparkConf().setMaster("spark://172.20.61.32:7077").setAppName("BucketedRandomProjectionforEuclideanDistance")
